...
import 'package:intern1/p1.dart';
import 'package:intern1/sign_in.dart';
import 'package:intern1/services/authservice.dart';
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Text('Choose Language',
                          style: TextStyle(
                              color: Colors.white,fontWeight: FontWeight.bold,fontSize: width/22
                          ),),
                        InkWell(
                          child: Card(child: Text('English',style: TextStyle(color: Colors.deepOrange,fontSize: width/22,fontWeight: FontWeight.bold),),elevation: 0,
                            color: Colors.transparent,),
                        ),
                        InkWell(
                          child: Card(child: Text('Bangla',style: TextStyle(color: Colors.deepOrange,fontSize: width/22,fontWeight: FontWeight.bold),),elevation: 0,
                            color: Colors.transparent,),
